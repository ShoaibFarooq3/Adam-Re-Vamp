  ...
  if (
    ...
    try {
      ...
      return {
        ...
        view: {
          layout: {
            mode: validateStringEnum(view?.layout?.mode, [
              'multi',
              'single'
            ]),
          ...
          showAxes: validateBoolean(
            view?.layout?.showAxis,
            () => true
          ),
          showShadows: validateBoolean(
            view?.layout?.showShadow,
            () => true
          ),
          lineNumbers: validateBoolean(
